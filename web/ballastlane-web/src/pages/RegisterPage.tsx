...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left brand panel */}
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-violet-700 via-indigo-600 to-blue-600 flex-col items-center justify-center p-16 text-white">
        <div className="max-w-sm">
          ...
          <h2 className="text-4xl font-bold leading-tight mb-4">Start managing better today</h2>
          <p className="text-indigo-200 text-lg leading-relaxed">Create your free account in seconds and start tracking your tasks immediately.</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12 bg-gray-50 dark:bg-gray-900">
        ...
        <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700">
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-5">
            ...
            <div>
              <label htmlFor="password" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Password <span className="text-gray-400 font-normal">(min 8 chars)</span></label>
              <div className="relative">
                <input id="password" name="password" type={showPassword ? 'text' : 'password'} autoComplete="new-password" required minLength={8}
            ...
            <button type="submit" disabled={isLoading}
              className="w-full py-3 px-4 bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold rounded-xl transition-all duration-150 shadow-sm flex items-center justify-center gap-2">
              {isLoading
