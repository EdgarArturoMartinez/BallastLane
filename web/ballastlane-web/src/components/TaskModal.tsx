        ...
        <form onSubmit={handleSubmit} noValidate className="px-6 pb-6 space-y-4">
          ...
          <div className="flex items-center justify-end gap-3 pt-2">
            ...
            <button type="submit" disabled={saving}
              ...
              {saving
                ? <><svg className="animate-spin w-4 h-4" viewBox="0 0 24 24" fill="none"><circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"/><path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v4a4 4 0 00-4 4H4z"/></svg>Savingâ€¦</>
